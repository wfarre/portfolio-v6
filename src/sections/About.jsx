...
const About = () => {
  ...
  return (
    <section
      id="aboutSection"
      ref={section}
      className="about-section px-desktop-responsive relative min-h-[100vh] bg-slate-950"
    >
      {/* <div
      ...
      <header
        ref={skillCard0}
        id="headerAbout"
        className="aboutHeader item flex flex-col items-center gap-6 py-13 text-center text-white opacity-100 md:flex-row md:items-end md:text-left"
      >
        <div className="md:flex-7/12">
        ...
        <div className="text-right md:flex-4/12">
          <ButtonLink
      ...
      <Skills title={"backend"} list={skills[0].list} />

      <Skills title={"backend"} list={skills[1].list} />

      <Skills title={"backend"} list={skills[2].list} />

      <Skills title={"backend"} list={skills[3].list} />
